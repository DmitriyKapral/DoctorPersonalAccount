...
namespace DoctorsClient.Migrations
{
    ...
    [Migration("20210714182935_testappointment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AccountTest", b =>
                {
                    ...
                    b.HasKey("Accountid", "Testid");

                    b.HasIndex("Testid");

                    b.ToTable("AccountTest");
                });
            ...
            modelBuilder.Entity("DoctorsClient.Models.Appointment", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("DoctorsClient.Models.AppointmentTest", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("DoctorsClient.Models.Outpatient_card", b =>
                {
                    ...
                    b.Property<List<int>>("test_resultid")
                        .HasColumnType("integer[]");
            ...
            modelBuilder.Entity("DoctorsClient.Models.Position", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("DoctorsClient.Models.Test_result", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Outpatient_cardTest_result", b =>
                {
                    b.Property<int>("Outpatient_Cardid")
                        .HasColumnType("integer");

                    b.Property<int>("Test_Resultid")
                        .HasColumnType("integer");

                    b.HasKey("Outpatient_Cardid", "Test_Resultid");

                    b.HasIndex("Test_Resultid");

                    b.ToTable("Outpatient_cardTest_result");
                });

            modelBuilder.Entity("AccountTest", b =>
                {
                    b.HasOne("DoctorsClient.Models.Account", null)
                        .WithMany()
                        .HasForeignKey("Accountid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DoctorsClient.Models.Test", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DoctorsClient.Models.Doctor", b =>
                {
                    b.HasOne("DoctorsClient.Models.Position", "Position")
                        .WithMany("Doctor")
            ...
            modelBuilder.Entity("Outpatient_cardTest_result", b =>
                {
                    ...
                    b.HasOne("DoctorsClient.Models.Test_result", null)
                        .WithMany()
                        .HasForeignKey("Test_Resultid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
